...
set_window_value(AT_UAIR, 3, AG_WINDOW_CUSTOM_GRAVITY, 0.9);
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_bite"));