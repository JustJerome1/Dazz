...
set_window_value(AT_USTRONG, 4, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 103);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -93);
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 120);
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 69);
set_hitbox_value(AT_USTRONG, 2, HG_SHAPE, 0);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITPAUSE_SCALING, 1.25);
...
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 83);
set_hitbox_value(AT_USTRONG, 3, HG_SHAPE, 0);
