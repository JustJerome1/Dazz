...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_WIDTH, 120);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HEIGHT, 120);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_VISUAL_EFFECT, 143);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HIT_SFX, asset_get("sfx_forsburn_reappear_hit"));
