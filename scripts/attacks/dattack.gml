...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, 63);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, -67);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_X, 110);
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_Y, -30);
set_hitbox_value(AT_DATTACK, 3, HG_WIDTH, 48);
...
set_hitbox_value(AT_DATTACK, 3, HG_HIT_SFX, asset_get("sfx_ori_energyhit_medium"));
...
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_X, 136);
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_Y, -31);
set_hitbox_value(AT_DATTACK, 4, HG_WIDTH, 41);
set_hitbox_value(AT_DATTACK, 4, HG_HEIGHT, 42);
...
set_hitbox_value(AT_DATTACK, 4, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_DATTACK, 4, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_DATTACK, 4, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_DATTACK, 4, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));